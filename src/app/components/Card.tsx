...
export default function Card({ foodData }: CardProps) {
  return (
    <div className="relative w-80 h-80 border-2 border-gray-800 rounded-lg overflow-hidden">
      <Image src={foodData.imageURL ? foodData.imageURL : '/images/pizza.jpg'} alt="FoodImage" sizes="(max-width: 768px) 100vw, (max-width: 1200px) 50vw, 33vw"  priority={true} fill style={{ objectFit: 'cover' }} />
